...
# Train the model
train_model(ncf, processed_train, processed_test, num_users, num_items, top_k=50, num_user_sample=min(100000, num_users), num_epochs=10, batch_size = 32, learning_rate=0.001)
